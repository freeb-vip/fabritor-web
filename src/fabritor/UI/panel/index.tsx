...
import { AlertOutlined, FileTextOutlined, PictureOutlined, BorderOutlined, BulbOutlined, AppstoreOutlined, FontColorsOutlined, TagsOutlined } from '@ant-design/icons';
...
const OBJECT_TYPES = [
  ...
  {
    label: <Trans i18nKey="panel.sticker.title" />,
    value: 'sticker',
